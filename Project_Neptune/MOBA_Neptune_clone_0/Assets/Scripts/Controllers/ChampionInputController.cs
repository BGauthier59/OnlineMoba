...
namespace Controllers.Inputs
{
    public class ChampionInputController : PlayerInputController
    {
        ...
        {
            // Todo - Stocker la position de la souris en World Space (appeler GetMouseOverWorldPos)


            // Todo - Stocker l'index de l'entité survolée s'il y en a une
        }
